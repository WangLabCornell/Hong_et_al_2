...
%braided DNA
Ceff_braid = 20;%nm, treat as force-independent--------------------------------------------------
torque_gap = 0;%pNnm, has to be smaller than buckling_torque_single------------------------------
...
for sigma_front = [sigma_front_range]
    ...
    if  sigma_front <= sigma_s
        ...
        turn_behind(count) = sigma_behind(count) * rho * Lk0;%add the not-scaling 0.5 turn
