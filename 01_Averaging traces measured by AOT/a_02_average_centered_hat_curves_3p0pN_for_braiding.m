...
extension_offset = 108;%nm, we corrected this offset using the extension predicted by the worm-like-chain model at zero turns 
...
figure(5)
subplot(2,1,1)
plot(turn_average_short,extension_average_short + extension_offset)
hold on
grid on
subplot(2,1,2)
...
a_final_hat_curve = {turn_average_short'  extension_average_short'+extension_offset  turn_average'  torque_average_shifted'};
